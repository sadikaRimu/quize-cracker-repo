...
const Blog = () => {
    return (
        <div>
            <h2 className='font-bold text-xl my-5'>Question & Answer</h2>
            <div>
                <div>
                    <h2 className='font-bold text-lg'>Question 1:  What is the purpose of react router?</h2>
                ...
                <div>
                    <h2 className='font-bold text-lg'>Question 2:  How does context API work?</h2>
                ...
                <div>
                    <h2 className='font-bold text-lg'>Question 3:  What is useRef hook in react?</h2>
